...
| **Administration / Center Admin** | `pages/platform/pages/administration/center-admin/`                                   | Bulk upload, SDG management, AGRESSO Pool Funding tag override, portfolio management, Bilateral Mapping ([`bilateral-mapping/`](../../research-indicators/src/app/pages/platform/pages/administration/center-admin/bilateral-mapping/) — AGRESSO↔CLARISA project mapping CRUD, spec [`bilateral-module/center-admin-project-mapping`](../specs/bilateral-module/center-admin-project-mapping/)) |
