...
> | Source path | `docs/specs/bilateral-module/indicator-mapping/backend-response-to-fe.md` |
> | Source branch | `AC-1594-bilateral-module-v2` |
> | Source commit | `cfbeb8ec` — *docs(bilateral-module/indicator-mapping): backend response to FE §6 audit* |
> | Source date | 2026-05-26 |
> | Snapshot taken | 2026-05-26 (by STAR / `AC-1594-bilateral-module`) |
> | Responds to | [`../indicator-mapping/open-questions-for-ba.md` §6](../indicator-mapping/open-questions-for-ba.md#6-backend-code-findings--2026-05-26-fe-side-audit--recommendations) |
>
> **How to read this file.**
> The body below is a verbatim copy of the backend response. Relative links inside (`../requirements.md`, `../frontend-handoff.md`, `server/researchindicators/...`, etc.) resolve **inside the ARI backend repo**, not from this location. Open them from the backend checkout at `alliance-research-indicators-main/docs/specs/bilateral-module/indicator-mapping/backend-response-to-fe.md` if you need to follow them.
>
> **Drift policy.** If the backend edits this response later (e.g. when PO/BA decisions land), refresh this snapshot in the same PR that reacts to the change on the STAR side. Bump the source commit + snapshot-taken rows above and note the diff in [`./README.md`](./README.md) "Change log" if that section exists.
>
> ---
