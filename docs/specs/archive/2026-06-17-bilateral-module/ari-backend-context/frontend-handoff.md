...
> | Source path | `docs/specs/bilateral-module/frontend-handoff.md` |
> | Source branch | `AC-1594-bilateral-module` |
> | Source commit | `7cb00e07` — *📝 docs(bilateral-module): add STAR frontend handoff doc* |
> | Source date | 2026-05-19 16:55:52 -05:00 |
> | Snapshot taken | 2026-05-19 (by STAR / `AC-1594-bilateral-module`) |
>
> **How to read this file.**
> The body below is a verbatim copy of the backend handoff. Relative links inside (`./requirements.md`, `../../../CLAUDE.md`, `../../../server/researchindicators/...`, etc.) resolve **inside the ARI backend repo**, not from this location. Open them from the backend checkout at `alliance-research-indicators-main/docs/specs/bilateral-module/frontend-handoff.md` if you need to follow them.
>
> **Drift policy.** When the backend updates this handoff, refresh this snapshot in the same PR that reacts to the change on the STAR side (or open a follow-up PR that does only the refresh). Bump the source commit + snapshot-taken rows above and note the diff in [`./README.md`](./README.md) §"Change log".
>
> ---
