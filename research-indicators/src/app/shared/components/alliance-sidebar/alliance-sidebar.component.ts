...
export class AllianceSidebarComponent implements OnInit {
  ...
  options = [
    ...
    { icon: 'info', label: 'About the tool', link: '1', underConstruction: true, hide: true },
    { icon: 'table_rows', label: 'Power BI dashboard', link: '23', underConstruction: true, hide: true },
    { icon: 'open_in_new', label: 'Other reporting tools', link: '45', underConstruction: true, hide: true },
    { icon: 'forum', label: 'Give feedback', underConstruction: true, hide: true }
  ];
